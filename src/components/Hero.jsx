    ...
    <div className="min-h-[90vh] grid grid-cols-1 md:grid-cols-10 md:gap-32 gap-12 justify-between items-center  mb-20">
      <div className="md:col-span-7">
        ...
        <h2 className="sub-heading-text mt-10">
          Influenced by the elegance of minimalism in design and take cues from
          my surroundings. My passion lies in building empathy, prototyping
          concepts, and iterating for the solution. I like creating interactive,
